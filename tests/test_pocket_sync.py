...
class FakeClient:
    def __init__(self): self.docs = {}; self.media = {}; self.calls = []; self.fail_library_412 = 0
    ...
    def put_media(self, song, name, path, size, checksum): self.calls.append(("PUT_MEDIA", name)); self.media[name]=(checksum,size); return self.media[name]
